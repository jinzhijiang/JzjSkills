...
|---|---:|---:|---|---:|
| Android | `$HUAWEI_ANDROID_PACKAGE_NAME` (per-project) | `1` | `build/app/outputs/flutter-apk/app-release.apk` | `5` |
| HarmonyOS | `$HUAWEI_OHOS_PACKAGE_NAME` (per-project) | `7` | `build/ohos/hap/entry-default-signed.hap` | `5` |
